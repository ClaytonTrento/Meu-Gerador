...
"                        t = new "+nomeDaClasse+"(aux[0],aux[1], Double.valueOf(aux[2]), Boolean.valueOf(aux[3].equals(\"Sim\")?true:false));//crie um objeto Trabalhador e preencha com dados.\n" +
...
"        btCarregarDados.doClick();//execute o listener do btCarregarDados");
        ...
        manipulaArquivo.salvarArquivo("/home/todos/alunos/cm/a1903691/NetBeansProjects/Cobaia1/src/Main/GUI.java", codigo);
                    }
}
}
